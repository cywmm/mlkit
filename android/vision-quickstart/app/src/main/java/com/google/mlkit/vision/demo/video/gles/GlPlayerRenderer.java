...
public class GlPlayerRenderer implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (frameListener != null) {
            ...
            handler.post(() -> {
                boolean isSave = simpleExoPlayer.getCurrentPosition()/1000 % 3 == 0L;
                Log.d(TAG, "onDrawFrame: " + isSave + "--" + simpleExoPlayer.getCurrentPosition());
                frameListener.onFrame(finalBitmap, isSave);
            });
        }
    }
    ...
    public interface FrameListener {
        ...
        void onFrame(Bitmap bitmap, boolean isSave);
    }
}
