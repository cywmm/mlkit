 ...
 */
public abstract class VisionVideoProcessorBase<T> implements VisionVideoProcessor {

    protected static final String MANUAL_TESTING_LOG = "LogTagForTest";
    private static final String TAG = "VisionProcessorBase2";
    ...
    protected VisionVideoProcessorBase(Context context) {
    ...
    private Task<T> setUpListener(
        ...
        return task.addOnSuccessListener(
                        ...
                        results -> {
                            ...
                            VisionVideoProcessorBase.this.onSuccess(results, graphicOverlay);
                            if (false) {
                                graphicOverlay.add(
                ...
                .addOnFailureListener(
                        ...
                        e -> {
                            ...
                            Log.d(TAG, error);
                            e.printStackTrace();
                            VisionVideoProcessorBase.this.onFailure(e);
                        })
